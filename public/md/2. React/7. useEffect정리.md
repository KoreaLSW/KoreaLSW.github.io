...
1️⃣ 컴포넌트 렌더링
2️⃣ DOM 업데이트
3️⃣ <b>useEffect 실행</b>
4️⃣ 다음 effect 실행 전 또는 컴포넌트 언마운트 시 → <b>return(cleanup) 실행</b>

즉, <b>화면이 먼저 렌더되고 effect가 실행</b>되는 것이 핵심이다.
...
➡️ 이렇게 하지 않으면 <b>메모리 누수 / 중복 실행 / 예기치 않은 버그</b>가 발생함.
